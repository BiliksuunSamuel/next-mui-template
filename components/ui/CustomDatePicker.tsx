...
const StyledDatePicker = styled(DatePicker)(({ theme }) => ({
  ...
  // Target the calendar icon adornment
...
export default function CustomDatePicker({ label, ...props }: IProps) {
      ...
      <FormControl sx={{ flex: 1 }} fullWidth={isMobile} variant="standard">
        {label && (
          <InputLabel
            ...
            shrink
            htmlFor={props.name ?? "custom-date-picker"}
          >
            {label}.{" "}
            {props.required && (
        ...
        <StyledDatePicker
          ...
          slotProps={{
            ...
            textField: {
              ...
              id: props.name ?? "custom-date-picker",
              variant: "outlined",
            },
          }}
        />
